...
- `New(capacity, intervalMS, processFunc)` creates a queue with the provided slice capacity, flush interval (milliseconds), and per-batch timeout (timeout defaults 5 seconds).
